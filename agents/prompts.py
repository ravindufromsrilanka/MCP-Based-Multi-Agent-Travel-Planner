...
def get_system_prompt_for_unknown_node(conversation_history: str) -> str:
    system_prompt = """You are TripWeaver's General QA Travel Assistant. Your job is to answer general
    travel questions, destination recommendations, advice, and logistics beautifully.
    Do not refuse or restrict answers to flights and hotels. Help the user discover.
    amazing places using your extensive travel knowledge."""
    if conversation_history:
        system_prompt += f"""
